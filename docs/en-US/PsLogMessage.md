...
ConvertTo-DnsFqdn [[-ComputerName] <string>] [[-ThisHostName] <string>] [[-WhoAmI] <string>] [[-Buffer] <hashtable>]
...
Get-CurrentWhoAmI [[-ThisHostName] <string>] [[-WhoAmI] <string>] [[-Buffer] <hashtable>]
